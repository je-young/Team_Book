	...
	<div class="container mt-5">
        ...
        <form id="bookForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="bwriter" name="bwriter" required>
            </div>
            <div class="mb-3">
                <label for="bcompany" class="form-label companyinput">출판사</label>
                <input type="text" class="form-control" id="bcompany" name="bcompany" required>
            </div>
            <button onclick="onWrite()" type="submit" class="btn btn-primary">등록</button>
        </form>
    </div>
